...
function triggerAttDropdownTrue() {
   ...
   showAcademicOptions.value = showExCurOptions.value = showOverallOptions.value = false;
}
...
function triggerAcademicDropdownTrue2() {
   ...
   showAttOptions.value = showExCurOptions.value  = showOverallOptions.value = false;
}
...
function triggerExCurDropdownTrue2() {
   ...
   showAttOptions.value = showAcademicOptions.value = showOverallOptions.value = false;
}
...
function triggerOverallDropdownTrue2() {
   ...
   showAttOptions.value = showAcademicOptions.value = showExCurOptions.value = false;
}
...
<template>
   <div class="tw-flex tw-w-full">
      <div class="tw-w-3/4 tw-bg-[#f8f4e3] tw-p-2">
         <div
            class="tw-flex tw-w-full tw-flex-col tw-gap-3 tw-border-4 tw-border-[#61b132] tw-p-1">
            <span class="tw-block">{{ selectedAttReport }}</span>
            <span class="tw-block">{{ selectedAcademicReport }}</span>
            <span class="tw-block">{{ selectedExCurReport }}</span>
            <span class="tw-block">{{ selectedOverallReport }}</span>
         </div>
      </div>
      <div class="tw-w-1/4 tw-bg-white tw-p-2">
            ...
            <div class="tw-relative tw-flex tw-w-72 tw-flex-col tw-p-1">
               ...
               <span
                  ...
                  class="tw-block tw-w-full tw-cursor-pointer tw-rounded-md tw-bg-cyan-200 tw-p-2 tw-text-[15px] tw-shadow-lg">
                  {{ attPlaceholder }}
               </span>
               <ul
